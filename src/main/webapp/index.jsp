    ...
    <div class="container">
        ...
        <form id="form" class="form-horizontal" role="form" style="margin-top: 73px;">
          <div class="form-group"  >
            <label for="username" class="col-xs-3 control-label col-sm-offset-3" >Username</label>
            <div class="col-xs-2">
              <input type="text" class="form-control" id="username" rel="tooltip"/>
            </div>
          </div>
          <div class="form-group">
            <label for="password" class="col-xs-3 control-label col-sm-offset-3">Password</label>
            <div class="col-xs-2">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#login').click(function() {
                //提交登录表单
                $.post(
					'${pageContext.request.contextPath}' + '/sys/login.do?type=1', {
